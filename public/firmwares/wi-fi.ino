...
void sendDataToServer() {
    ...
    int httpCode = http.POST("values[{sensor-temperature-id}]="+String(temperature)+"&values[{sensor-humanity-id}]="+String(humanity)+"&values[{sensor-gercon1-id}]="+String(gercon));
